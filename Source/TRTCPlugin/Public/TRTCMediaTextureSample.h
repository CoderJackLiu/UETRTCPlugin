...
class FTRTCMediaTextureSample
	: public IMediaTextureSample
	  , public IMediaPoolable
{
public:
	FTRTCMediaTextureSample()
		: Buffer(nullptr)
		  , BufferSize(0)
	...
	/** Virtual destructor. */
	virtual ~FTRTCMediaTextureSample() override
	{
		FreeBuffer();
	}
	 ...
	 */
	bool Initialize(const FIntPoint& InDim, const FIntPoint& InOutputDim, EMediaTextureSampleFormat InSampleFormat, uint32 InStride, FTimespan InDuration)
	{
...
class FTRTCMediaTextureSamplePool : public TMediaObjectPool<FTRTCMediaTextureSample>
{
};
