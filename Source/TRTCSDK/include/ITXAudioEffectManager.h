...
// the C++ interface will be declared under the namespace liteav after v9.0. To be compatible with the previous usage, trtc will be used as an alias for liteav
